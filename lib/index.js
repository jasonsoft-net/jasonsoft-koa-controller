 ...
 */
export default (router, dir = 'src/controllers', debug = false) => {
  /** 项目根目录路径 */
  let project_dir = resolve();
  if (debug) {
    console.log('project_dir:', project_dir);
  }
  /** 注入指定目录下的所有控制器 */
  injectControllers(router, join(project_dir, dir), debug);
};
